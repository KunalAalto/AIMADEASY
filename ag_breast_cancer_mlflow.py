...
experiment_name = "/Users/user_name/name_of_experiment" # put your own path
...
if best_model is not None:
    ...
    packaging_dir = "/dbfs/mnt/archive/packaged_models" # put your own path
...
model_path = "/dbfs/mnt/archive/packaged_models/MLmodel" # put your own path
